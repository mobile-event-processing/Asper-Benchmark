package asper.evaluation.asper;

import asper.evaluation.Settings;
import asper.evaluation.asper.listener.Listener;
import asper.evaluation.database.Database;
import asper.evaluation.task.Event;
import asper.evaluation.task.Variable;
...
public class Asper
{
     ...
     */
    public static void addQuery(String name, String query)
    {
